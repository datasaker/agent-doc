...
In the current Amazon Linux 2023 environment, if the preceding task of ‘DataSaker’ has not been carried out, please proceed with the preceding task of ‘DataSaker’ first. [DataSaker predecessors] (README.md)
