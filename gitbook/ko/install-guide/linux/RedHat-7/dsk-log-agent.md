...
현재 RedHat 7  환경에서 `DataSaker`의 선행 작업이 진행되지 않으셨다면 `DataSaker` 선행 작업을 먼저 진행하여 주시기 바랍니다. [DataSaker 선행 작업](README.md)
...
fluent-bit 패키지 설치에 대한 자세한 내용은 [공식문서](https://docs.fluentbit.io/manual/installation/linux/redhat-centos)를 참고합니다.
